...
export default async function EditPage({searchParams: {id}}: {searchParams : {id:string}}) {
  ...
  return (
    <form action={editEntry}>
        ...
        <input type="text" name="title" id="title" placeholder='Title' defaultValue={entry?.title}/>
        <label htmlFor="content">Content</label>
        <textarea name="content" id="content" placeholder='Content' defaultValue={entry?.content}/>
